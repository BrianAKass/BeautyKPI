        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="success" stats icon>
              ...
              <p className={classes.cardCategory}>Overall Brand Perception</p>
          ...
          <Card>
            <CardHeader color="success" stats icon>
              ...
              <p className={classes.cardCategory}>
                <span className={classes.successText}>55%</span> increase in
                today sales.
              </p>
              <h3 className={classes.cardTitle}>Daily Sales</h3>
            </CardHeader>
            <CardBody chart>
              <ChartistGraph
                className="ct-chart"
        ...
        <GridItem xs={12} sm={6} md={4}>
          <Card>
            <CardHeader color="info" stats icon>
              ...
              <h3 className={classes.cardTitle}>Social Breakdown</h3>
            </CardHeader>
            <CardBody>
              <GridContainer>
                <GridItem
        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            <CardHeader color="warning" stats icon>
              ...
              <h3 className={classes.cardTitle}>Hastag growth</h3>
            </CardHeader>
            <CardBody>
              <ChartistGraph
                className="ct-chart"
        ...
        <GridItem xs={12} sm={6} md={4}>
          <Card>
            <CardHeader color="warning" stats icon>
              ...
              <h3 className={classes.cardTitle}>Influencer Volume</h3>
              <p className={classes.cardCategory}>
